...
filename_1 = 'vicon_X60_slow.xlsx';
% Write table to file 
writetable(T,filename_1)
% Print confirmation to command line
fprintf('Results table with %g vicon X measurements saved to file %s\n',...
    length(timeSecs), filename_1)

T = table(timeSecs', angle_Y','VariableNames',{'Time','angle_Y'});
filename_2 = 'vicon_Y60_slow.xlsx';
% Write table to file 
writetable(T,filename_2)
% Print confirmation to command line
fprintf('Results table with %g vicon Y measurements saved to file %s\n',...
    length(timeSecs), filename_2)

T = table(timeSecs', angle_Z','VariableNames',{'Time','angle_Z'});
filename_3 = 'vicon_Z60_slow.xlsx';
% Write table to file 
writetable(T,filename_3)
% Print confirmation to command line
fprintf('Results table with %g vicon Z measurements saved to file %s\n',...
