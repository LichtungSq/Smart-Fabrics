...
systemParameters.ScopeAddress = 'USB0::0x0957::0x175D::MY50340962::0::INSTR';
...
addpath('./UI', './SISO OFDM', './SISO PAM', './SM PAM', './MIMO PAM', './Freq Resp', './SM OFDM', './MIMO OFDM','./+uiextras','./layout','./layoutHelp/','./Patch');
