...
try
    ...
    %% Send data to AWG
    [M_theory, P_theory] = OFDM_optimal_constellation_allocation2(OFDMParameters.maxConstellation,OFDMParameters.Nfft,0,8e-4,10.^(SISOOFDM.SINREstimate/10));
    ...
    if ~isempty(sampleNumber),
        ...
        movegui(h,'center');
        drawnow;
        [SISOOFDM.BER, channel, estimated_channel, SNR, estimated_SNR, fitted_SNR, fitted_SNR2, SISOOFDM.SINREstimate, ~] = ...
        ...
        if inputType == 2,
            SISOOFDM.waveDataOUT.YData = waveDataOUT.YData - waveform2.YData;
        end
