...
sensor1_loess = smooth(sensor1,25,'rlowess', 2);
sensor2_loess = smooth(sensor2 + slope_cmp, 25, 'rlowess', 2);
...
for i = 1:length(up_point)
    stretch(up_point(i):down_point(i)-1) = sensor2_per(up_point(i) - 1);
end
