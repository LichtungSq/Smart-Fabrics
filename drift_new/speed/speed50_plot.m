per_data = xlsread('nonstop50_baregrey_2layer_heat_slp1_spe50_pull20_per.xlsx');
...
locs(id,:) = [];
pks(id,:) = [];
locs_1 = locs(11:2:end)-5;
pks_1 = pks(11:2:end);

id_t = find(loc_ts(:,1) < 5 | loc_ts(:,1) > 71);
loc_ts(id_t,:) = [];
troughs(id_t,:) = [];
loc_ts = loc_ts(10:2:end)-5;
troughs = troughs(10:2:end);
...
xlswrite('peaks_50.xls',matrix,'Sheet1');
xlswrite('troughs_50.xls',matrix_1,'Sheet1');